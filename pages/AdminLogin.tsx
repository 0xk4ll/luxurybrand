        ...
        <div className="bg-white rounded-[2.5rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.08)] p-10 md:p-12 border border-white">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 font-light">
              Kelola katalog dan konten Anda
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative group">
                <Mail
                  className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-green-600 transition-colors"
                  size={18}
                />
                <input
                  type="email"
